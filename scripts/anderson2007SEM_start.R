...
summary(Leaf_N_fit,standardized=TRUE,fit.measures=T,rsquare=T)
...
# show the model results
summary(Leaf_P_fit,standardized=TRUE,fit.measures=T,rsquare=T)
